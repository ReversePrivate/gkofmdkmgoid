...
$(document).ready(() => {
  const links = [
    {
      name: 'Insta',
      link: 'https://www.instagram.com/noimnotalex/?hl=en',
    },
    {
      name: 'Discord',
      link: 'discord.gg/botnet',
    },
  ...
  for (let i in links) {
    ...
    $('#marquee').append(`<a href="https://${link.link}">${link.name}</a>`);
  ...
  app.titleChanger(['QuantumSecurity', 'QuantumSecurity.', 'QuantumSecurity.c', 'QuantumSecurity.cf', 'QuantumSecurity.c', 'QuantumSecurity.', 'QuantumSecurity']);
  app.iconChanger(['assets/icons/main/843536452125720596.jpg', 'assets/icons/main/845738231658971186.jpg', 'assets/icons/main/851493033765503006.jpg', 'assets/icons/main/862785160277524520.jpg', 'assets/icons/main/868209447099596810.jpg', 'assets/icons/main/900746955163054101.jpg', 'assets/icons/main/971922288284954704.jpg']);
});
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>USER</span>...","Error occurred connections interupted... retrying.... <span style='font-size: 14px; color: #0f0;'>[CONNECTED]</span> "], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>QUANTUMSECURITY.CF</i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
